      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                드래그앤드롭, 청크 업로드, 일시정지/재개가 지원되는 고급 파일
                업로드
              </p>
            </div>
          </div>
        ...
        <Card className="border-figure-500 bg-figure-50">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span className="text-figure-700">고급 업로드 기능</span>
            </CardTitle>
            <CardDescription className="text-figure-600">
              향상된 사용자 경험을 위한 고급 파일 업로드 기능들을 제공합니다
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-figure-200">
                <div className="w-8 h-8 rounded-full bg-figure-100 flex items-center justify-center">
                  <Zap className="h-4 w-4 text-figure-600" />
                </div>
                <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>고급 업로드 시스템의 기술적 특징</CardDescription>
          </CardHeader>
          <CardContent>
